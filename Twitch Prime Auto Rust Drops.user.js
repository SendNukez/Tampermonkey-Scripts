                ...
                if (fpDrops.length > 0 && twDrops.length > 0) {
                    ...
                    if (currentDrop) {
                        ...
                        if (remainingDropsLive.length > 0) {
                            ...
                            console.log(`[Auto Rust Drops] %cNobody Online :( %c Remaining: %c${remainingDrops.map((drop) => drop.name).join(", ")}`, "color: red; font-weight: bold;", "color: none", "color: purple; font-weight: bold;");
                        }
